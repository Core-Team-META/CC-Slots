...
local FOV_ACTION = "ability_extra_33" -- Keyboard F
...
function OnBindingPressed(player, action)
	...
	-- Increase/decrease flying speed. Ignore if the FOV button is being held
	if not actionsPressed[player][FOV_ACTION] then
		-- Shift to speed up
